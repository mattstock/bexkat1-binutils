...
const bexkat1_opc_info_t bexkat1_opc_info[] =
  {
    ...
    { 0xe4, 2, BEXKAT1_INH2,   "cvtis" },
    { 0xe5, 2, BEXKAT1_INH2,   "cvtsi" },
    ...
    { 0x2b, 3, BEXKAT1_IMM3,    "muliu" },
    { 0x2c, 3, BEXKAT1_IMM3,    "diviu" },
    { 0x2d, 3, BEXKAT1_IMM3,    "modiu" },
    ...
    { 0x2b, 3, BEXKAT1_REG,     "mulu" },
    { 0x2c, 3, BEXKAT1_REG,     "divu" },
    { 0x2d, 3, BEXKAT1_REG,     "modu" },
