...
const bexkat1_opc_info_t bexkat1_opc_info[BEXKAT1_OPC_COUNT] =
  {
    ...
    { 0x01, BEXKAT1_F0_NARG, BEXKAT1_ADDR_INH, "rts" },
    { 0x02, BEXKAT1_F0_NARG, BEXKAT1_ADDR_INH, "rti" },
    { 0x03, BEXKAT1_F0_A,    BEXKAT1_ADDR_REG, "inc" },
    { 0x04, BEXKAT1_F0_A,    BEXKAT1_ADDR_REG, "dec" }, 
    ...
    { 0x04, BEXKAT1_F1_ABC,  BEXKAT1_ADDR_REG, "lsl" },
    { 0x05, BEXKAT1_F1_ABC,  BEXKAT1_ADDR_REG, "asr" },
    ...
    { 0x21, BEXKAT1_F1_AB,   BEXKAT1_ADDR_IND, "ld.l" },
    { 0x30, BEXKAT1_F1_AB,   BEXKAT1_ADDR_IND, "st" },
    { 0x31, BEXKAT1_F1_AB,   BEXKAT1_ADDR_IND, "ld" },
    { 0x40, BEXKAT1_F1_AB,   BEXKAT1_ADDR_IND, "st.b" },
    { 0x41, BEXKAT1_F1_AB,   BEXKAT1_ADDR_IND, "ld.b" },
    ...
    { 0x10, BEXKAT1_F3_A_32V, BEXKAT1_ADDR_IMM, "ldi" },
    { 0x20, BEXKAT1_F3_A_ABSADDR, BEXKAT1_ADDR_DIR, "st.l" },
    { 0x21, BEXKAT1_F3_A_ABSADDR, BEXKAT1_ADDR_DIR, "ld.l" }, 
    { 0x30, BEXKAT1_F3_A_ABSADDR, BEXKAT1_ADDR_DIR, "st" }, 
    { 0x31, BEXKAT1_F3_A_ABSADDR, BEXKAT1_ADDR_DIR, "ld" }, 
    { 0x40, BEXKAT1_F3_A_ABSADDR, BEXKAT1_ADDR_DIR, "st.b" },
    { 0x41, BEXKAT1_F3_A_ABSADDR, BEXKAT1_ADDR_DIR, "ld.b" }, 
    { 0x50, BEXKAT1_F3_ABSADDR, BEXKAT1_ADDR_DIR, "jmp" },
    { 0x51, BEXKAT1_F3_ABSADDR, BEXKAT1_ADDR_DIR, "jsr" }
  };
